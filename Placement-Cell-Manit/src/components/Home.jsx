    ...
    <div className="bg-gray-900 text-white">
      <main className="py-20 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg mb-8">
          ...
          justo id nunc tincidunt, a tincidunt nisl ultrices. Nulla facilisi.
          Sed in mauris id nunc lacinia lacinia. Nullam auctor, nunc at aliquam
          ultricies, nunc tellus tincidunt nunc, a aliquet nunc urna id mi.
        </p>
